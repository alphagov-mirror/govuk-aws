...
| private\_subnet\_nat\_gateway\_association | Map of private subnet names and public subnet used to route external traffic (the public subnet must be listed in public_subnet_nat_gateway_enable to ensure it has a NAT gateway attached) | map | n/a | yes |
...
| private\_subnet\_elasticache\_names\_route\_tables\_map | Map containing the name of each private subnet and route_table ID associated |
...
| private\_subnet\_elasticsearch\_names\_route\_tables\_map | Map containing the name of each private subnet and route_table ID associated |
