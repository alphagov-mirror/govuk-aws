...
| instance\_type | Instance type used for RDS resources | string | `"db.m4.xlarge"` | no |
...
| storage\_size | Defines the AWS RDS storage capacity, in gigabytes. | string | `"30"` | no |
