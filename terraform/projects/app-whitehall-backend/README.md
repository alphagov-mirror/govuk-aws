...
| Name | Description |
|------|-------------|
| external\_service\_dns\_name | DNS name to access the external node service |
| internal\_service\_dns\_name | DNS name to access the node service |
| whitehall-backend\_external\_elb\_address | AWS' external DNS name for the whitehall-backend ELB |
| whitehall-backend\_internal\_elb\_address | AWS' internal DNS name for the whitehall-backend ELB |
