...
variable "ukcloud_internal_net_cidr" {
  type        = "string"
  description = "Internal network range of the environment in ukcloud"
}
...
resource "aws_vpn_connection_route" "ukcloud" {
  destination_cidr_block = "${var.ukcloud_internal_net_cidr}"
